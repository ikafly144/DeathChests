...
execute in nullscape:end_island run gamerule keepInventory true

tellraw @a {"text": "Death Chestの導入が完了しました。","color": "gold"}
tellraw @a {"text": "  Death Chest installation completed.","color": "gold"}